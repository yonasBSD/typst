...
= #short-or-long[Getting Started][How do I create a new, empty document?] <getting-started>
...
= #short-or-long[Elements][How do I create section headings, emphasis, ...?] <elements>
...
#docs-table(
  table.header[Element][LaTeX][Typst][See],
...
= #short-or-long[Commands][How do I use a command?] <commands>
...
#docs-table(
  table.header[Data type][Example],
...
== #short-or-long[Rules][Commands to affect the remaining document] <rules>
...
= #short-or-long[Templates][How do I load a document class?] <templates>
...
= #short-or-long[Packages][How do I load packages?] <packages>
...
#docs-table(
  table.header[LaTeX Package][Typst Alternative],
  ...
  [babel, polyglossia],
  [@text.lang[`text`] function: `[#set text(lang: "zh")]`],

  [amsmath],
  [@math[Math mode]],

  [amsfonts, amssymb],
  [@reference:symbols[`sym`] module and @reference:syntax:math[syntax]],
  ...
  [@cite, @bibliography functions],

  [lstlisting, minted],
  [@raw function and syntax],

  [parskip],
  [@block.spacing[`block`] and @par.first-line-indent[`par`] functions],

  [csquotes],
  [Set the @text.lang[`text`] language and type `["]` or `[']`],

  [caption],
  [@figure function],

  [enumitem],
  [@list, @enum, @terms functions],
...
= #short-or-long[Maths][How do I input maths?] <maths>
...
= #short-or-long[Latex Look][How do I get the "LaTeX look?"] <latex-look>
...
= #short-or-long[Limitations][What limitations does Typst currently have compared to LaTeX?] <limitations>
