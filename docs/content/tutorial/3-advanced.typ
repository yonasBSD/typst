#import "../../components/index.typ": details, docs-chapter, docs-figure, example, info, short-or-long
...
= #short-or-long[Guidelines][The conference guidelines] <guidelines>
...
= #short-or-long[Set Rules][Writing the right set rules] <set-rules>
...
= #short-or-long[Title And Abstract][Creating a title and abstract] <title-and-abstract>
...
= #short-or-long[Columns And Headings][Adding columns and headings] <columns-and-headings>
