...
= #short-or-long[Toy Template][A toy template] <toy-template>
...
= #short-or-long[Set And Show Rules][Embedding set and show rules] <set-and-show-rules>
...
= #short-or-long[Separate File][A separate file] <separate-file>
